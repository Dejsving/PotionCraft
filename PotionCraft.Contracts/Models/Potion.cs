...
public class Potion
{
    /// <summary>Уникальный идентификатор зелья.</summary>
    public Guid Id { get; set; } = Guid.NewGuid();

    /// <summary>Название зелья.</summary>
    public string Name { get; set; } = string.Empty;

    /// <summary>Описание эффекта зелья.</summary>
    ...
    /// <summary>Количество доз.</summary>
    public int Doses { get; set; } = 1;

    /// <summary>Продолжительность действия в раундах (0 = мгновенное).</summary>
